...
action "Validate Docker" {
  ...
  args = "/bin/hadolint docker/google-maps-email/Dockerfile docker/google-maps-views/Dockerfile docker/html-validator/Dockerfile docker/js-validator/Dockerfile docker/yelp-email/Dockerfile"
}
